...
<div style="position: absolute;left: 35%;top: 15%;width: 53%;">
    ...
    <form id="changepwd_form" action="<s:url namespace="/user" action="resetPassword"/>" method="post">
        <div class="form-group">
            ...
            <input type="password" class="form-control validate[required]" id="oldPassword" name="oldPassword"
                   placeholder=""/>
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control validate[required]" id="newPassword" name="newPassword"
                   placeholder=""/>
        </div>
        <div class="form-group">
            <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
            <label>Confirm new password</label>
            <input type="password" class="form-control validate[required,equals[newPassword]]" id="conf_new_pwd"
                   placeholder=""/>
        </div>
